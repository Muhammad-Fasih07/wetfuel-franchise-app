...
import { createFranchisee } from "@/lib/api/franchisees";
...
export default function NewFranchiseePage() {
  ...
  const onSubmit = async (values: FormValues) => {
    // TODO: wire to lib/api/franchisees.ts createFranchisee with full payload
    ...
    setToastOpen(true);
    setTimeout(() => router.push("/franchisees"), 600);
  };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      <PageHeader
        ...
        subtitle="Add a new franchise partner to the network."
        action={
          <Button
            variant="ghost"
            fullWidth={false}
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <Input
                  ...
                  register={register("billingContact")}
      ...
      >
        ...
        >
          Franchisee registered successfully.
        </Alert>
      </Snackbar>
    </div>
  );
